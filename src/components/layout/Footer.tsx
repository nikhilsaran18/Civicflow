...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-slate-950 text-slate-400 py-12 border-t border-purple-900/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-white tracking-tight font-editorial">CivicFlow AI</span>
            </div>
            ...
            <div className="flex items-center gap-2 text-xs text-slate-400 bg-slate-900/90 p-3 rounded-xl border border-purple-900/40">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-slate-400">
              <li><a href="https://rtionline.gov.in" target="_blank" rel="noreferrer" className="hover:text-purple-300 transition-colors">RTI Online Portal</a></li>
              <li><a href="https://pgportal.gov.in" target="_blank" rel="noreferrer" className="hover:text-purple-300 transition-colors">CPGRAMS Grievance Portal</a></li>
              <li><a href="https://consumerhelpline.gov.in" target="_blank" rel="noreferrer" className="hover:text-purple-300 transition-colors">National Consumer Helpline</a></li>
              <li><a href="https://www.ugc.gov.in" target="_blank" rel="noreferrer" className="hover:text-purple-300 transition-colors">UGC Student Grievance</a></li>
            </ul>
          </div>
        </div>
